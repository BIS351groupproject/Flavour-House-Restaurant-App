...
- Check out the UI/UX web project implemented in code built with HTML: [View HTML](https://github.com/BIS351groupproject/Flavour-House-Restaurant-App/blob/main/index.html)
